...
4. **THE ANALYST PROTOCOL:** When researching products, bias results to the owner's region and currency as given in the [OWNER] facts — do NOT assume a country. Account for local availability and true cost including shipping/import to that region.