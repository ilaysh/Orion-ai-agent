...
class OrionAssistant:
    ...
    def setup_ui(self):
        ...
        self.orb = AnimatedOrb(self.orb_canvas, 100, 100)  # Centered at 100,100
        ...
        # Input frame
        input_frame = ctk.CTkFrame(main_frame, fg_color="transparent", height=50)
    ...
    def send_message(self, event=None):
        ...
        if message:
            ...
            self.window.after(2000, lambda: self.status.configure(text="Status: Listening..."))
